// A reference banner usable by BOTH a server (authoritative pulls) and a client
// (display of the pool). Pure data — lives in the summon package so the two ends
// can never disagree about the drop table. A real game would load many banners;
// the reference ships one.
